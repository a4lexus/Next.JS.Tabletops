...
const navigation = [
  ...
  { name: "Post", href: "/blog/post", current: false },
  { name: "Find & Play", href: "/playground/find-play", current: false },
  { name: "FAQ", href: "/help/faq", current: false },
];
            ...
            <div className="flex h-16 items-center justify-between">
                      ...
                      <Link
                        ...
                        className={classNames(
                          item.current
                            ...
                            : "text-gray-300 hover:bg-white/8 hover:text-amber-300",
              ...
              <div className="hidden md:block">
                <div className="ml-4 flex items-center md:ml-6">
                  <button
                    type="button"
                    className="relative rounded-full p-1  hover:text-amber-300 text-gray-400 focus:outline-3 focus:outline-offset-2 focus:outline-indigo-500"
                  >
                  ...
                  <Menu as="div" className="relative ml-3">
                    ...
                    <MenuItems className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-gray-800 py-1 outline-1 -outline-offset-1 outline-white/10 transition duration-100 ease-out">
